...
export const listProject = [
  ...
  },
  {
    ...
    descBackoffice:
      "A partir du persona principal j’ai pu réaliser une user journey map de ce persona en décrivant les différentes étapes de son parcours de la recherche internet jusqu’à la réception du produit.",
    rechercheUtilisateur:
      "J’ai commencé par trouver l’idée puis déterminer si cela pouvait intéresser des personnes en faisant des recherches internet puis un questionnaire sur ma cible envisagée. Les résultats sortant de ces études m’ont permis de dresser deux persona ainsi que de définir la cible principale et de savoir qu’il y avait bel et bien un marché pour ma proposition.",
    ...
    ciblePrincipaleSuite:
      "Les personnes entre 18 et 25 dépensent en moyenne plus pour leur budget mode : 116 euros/mois contre 82 euros/mois. Ce qui donne environ 1 392€/an. Republik Retail Une autre étude évoque que les femmes de 18-25 ans dépensent en moyenne 1 280 €/an. étude de l’application de shopping Joko",
    wireframes: [
      `/data/img/Nysos/wireframe_1.png`,
      `/data/img/Nysos/wireframe_2.png`,
    ],
    wireframesDesc:
      "Le site internet étant un site e-commerce qui a donc pour objectif de vendre des produits mais également de permettre aux personnes de prendre contact avec l’artiste, j’ai décidé de créer une version mobile et desktop.   La version mobile est privilégié et c’est une PWA réalisé sur Shopify parce que cela comporte de nombreux avantages : cela apporte fluidité et rapidité, une cohérence cross-device et permet un engagement et rétention accrue sur le site internet. 93% des 18-24 ans possèdent un smartphone et installent davantage d’applications de shopping que la moyenne, 46 % contre 32 % en moyenne nationale, ce que permet les PWA. L’utilisation de la solution PWA pour cette population (ma cible) est adaptée parce qu’elle répond à leur attentes. ",
